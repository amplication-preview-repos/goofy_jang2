...
import { Appraiser } from "../../appraiser/base/Appraiser";
...
export class PropertyResolverBase {
  ...
  async createProperty(
    ...
    return await this.service.createProperty({
      ...
      data: {
        ...
        appraiser: args.data.appraiser
          ? {
              connect: args.data.appraiser,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => Appraiser, {
    nullable: true,
    name: "appraiser",
  })
  async getAppraiser(
    ...
    const result = await this.service.getAppraiser(parent.id);
